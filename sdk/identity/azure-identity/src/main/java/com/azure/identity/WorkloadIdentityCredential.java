 ...
 * authentication, applications authenticate themselves using their own
 * identity, rather than using a shared service
 ...
 * The WorkloadIdentityCredential supports Azure workload identity
 * authentication on Azure Kubernetes and acquires
 * a token using the service account credentials available in the Azure
 * Kubernetes environment.
 * Refer to <a href=
 * "https://learn.microsoft.com/azure/aks/workload-identity-overview">Azure
 * Active Directory
 * Workload Identity</a> for more information.
 * </p>
 *
 * <p>
 * <strong>Sample: Construct WorkloadIdentityCredential</strong>
 * </p>
 *
 * <p>
 * The following code sample demonstrates the creation of a
 * {@link WorkloadIdentityCredential},
 * using the {@link WorkloadIdentityCredentialBuilder} to configure it. The
 * {@code clientId},
 * is required to create {@link WorkloadIdentityCredential}. Once this
 * credential is created, it may be passed into the
 * builder of many of the Azure SDK for Java client builders as the 'credential'
 * parameter.
 * </p>
 *
 * <!-- src_embed
 * com.azure.identity.credential.workloadidentitycredential.construct -->
 * 
 * <pre>
...
public class WorkloadIdentityCredential implements TokenCredential {
     ...
     *
     * @param tenantId ID of the application's Azure Active Directory.
     * @param clientId The client ID of an Azure AD app registration.
     * @param federatedTokenFilePath The path to a file containing a federated token.
    ...
    String getTenantId() {
        return this.identityClient.getTenantId();
    }
